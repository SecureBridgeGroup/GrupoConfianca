      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Solicite um orçamento gratuito para sua empresa ou condomínio em Manaus.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none outline-none transition-all"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-green-600 text-white py-4 rounded-lg font-semibold hover:bg-green-700 transition-all flex items-center justify-center space-x-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:scale-95"
              >
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-6">
              {[
                { 
                  icon: Mail, 
                  title: 'E-mail', 
                  content: 'direcao@gpconfianca.com.br', 
                  link: 'mailto:direcao@gpconfianca.com.br' 
                },
                { 
                  icon: Phone, 
                  title: 'Telefone / WhatsApp', 
                  content: '(92) 99291-1914', 
                  link: 'https://wa.me/5592992911914' 
                },
                { 
                  icon: MapPin, 
                  title: 'Localização', 
                ...
                <div key={i} className="flex items-start space-x-4 group">
                  <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-green-600 group-hover:text-white transition-all duration-300">
                    <item.icon size={24} />
                  </div>
                  <div>
            ...
            <div className="bg-green-600 text-white rounded-2xl p-8 shadow-xl">
              <h4 className="font-bold text-xl mb-4">Atendimento ao Cliente</h4>
              <div className="space-y-3 opacity-90">
                ...
                <div className="pt-4 border-t border-white/20 mt-4">
                  <p className="flex items-center text-sm">
                    ...
                    <span className="font-bold">Plantão Emergencial:</span> 24 horas por dia
                  </p>
                </div>
              </div>
            </div>
